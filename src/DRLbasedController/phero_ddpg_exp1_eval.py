...
import phero_turtlebot_exp1_eval2
import numpy as np
import os
import sys
print(sys.path)
...
class ActorCritic:
	def __init__(self, env, sess):
		...
		self.save_dir = "/home/sub/catkin_ws/src/Turtlebot3_Pheromone/src/results/trained_weights/exp1/PER/" 
...
def main(args):
	...
	K.set_session(sess)
	########################################################
	game_state= phero_turtlebot_exp1_eval2.Env()   # game_state has frame_step(action) function
	...
	if train_indicator==0:
		for i in range(num_trials):
			...
			actor_critic.actor_model.load_weights(actor_critic.save_dir + "20210412-134632actormodel-590-256.h5")
			actor_critic.critic_model.load_weights(actor_critic.save_dir + "20210412-134632criticmodel-590-256.h5")
			##############################################################################################
			total_reward = 0
