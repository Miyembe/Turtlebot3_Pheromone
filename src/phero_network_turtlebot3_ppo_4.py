...
import phero_turtlebot_turtlebot3_repellent_ppo_4
import numpy as np
import os
import sys
    ...
    def learn(self):
        ...
        for update in range(1, nupdates+1):
            ...
            if update % log_interval == 0 or update == 1:
                ...
                sio.savemat('/home/swn/catkin_ws/src/Turtlebot3_Pheromone/src/log/MATLAB/step_reward_{}.mat'.format(time_str), {'data':step_reward},True,'5',False,False,'row')
...
def main():
    env = phero_turtlebot_turtlebot3_repellent_ppo_4.Env()
